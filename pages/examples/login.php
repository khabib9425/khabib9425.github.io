...
<div class="login-box">
  <div class="login-logo">
    <a href="../../index.html"><b>My Mail</b>JIZPI</a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
        ...
        <div class="row">
          <div class="col-8">
            <div class="icheck-primary">
              <input type="checkbox" id="remember" name="remme">
              <label for="remember">
                Запомните меня
              </label>
            </div>
          ...
          <!-- /.col -->
          <div class="col-4">
            <button type="submit" name="logBtn" class="btn btn-primary btn-block">Войти</button>
          </div>
          <!-- /.col -->
        </div>
      </form>
